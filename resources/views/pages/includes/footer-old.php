<div class="footer-top">
  ...
  <div class="title-box text-center">
      <h1 class="title"><?php echo $convert_lang['testimonial'];?></h1>
  </div>
<div class="full-width-box bottom-padding">
    <div class="fwb-bg fwb-blur" data-blur-image="<?php echo SITE_URL; ?>images/testimonials-background.jpg" data-blur-amount="3">
      ...
      <div class="row">
        <div class="carousel">
          ...
          <?php
              ...
              {
              while($rowtst1=mysql_fetch_object($testmo1))
              { 
                
                $uimg = $rowtst1->u_image;
                if($uimg == '')
        ...
        <div class="respond respond-blockquote border white col-sm-12 col-md-12">
          ...
          <blockquote><?php echo $rowtst1->tst_msg;?>
          </blockquote>
          </div>
          <div class="name">
          <div class="icon">
            <img class="img-circle" src="<?php echo SITE_URL.$imgpath;?>" alt="">
          </div>
          
          <strong><?php echo $rowtst1->u_name; ?></strong>
          <div><?php if($rowtst1->tst_date != '') echo date("M d, Y", $rowtst1->tst_date); else echo ''; ?></div>
          </div>
        </div>
        <?php 
              $im++;
        ...
        <nav>
          <ul>
            <?php if( isset($_SESSION['useruserid']) && $_SESSION['useruserid']!='' ){ ?>
                <li><a href="<?php echo SITE_URL; ?>dashboard.php">My account</a></li>
                <!--<li><a href="#">Newsletter</a></li>-->
            <?php } else {?>
            <!--<li><a href="#">Order History</a></li>
            <li><a href="#">Wish List</a></li>-->
                <li><a href="<?php echo SITE_URL; ?>login.php">Login</a></li>
                <li><a href="<?php echo SITE_URL; ?>login.php">Sign-up</a></li>
            <?php } ?>
          </ul>
        </nav>
      </aside>
